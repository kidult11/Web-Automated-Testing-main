...
# 账号
login_input_account = By.CSS_SELECTOR,"#username"
...
# 退出按钮
login_logout = By.XPATH,"/html/body/div[1]/div/div[2]/ul/li[3]/a"  #"//a[text()='退出']"
...
# 登录失败
login_passwd_fail = By.XPATH,"//span[text()='密码格式错误']"
# 未勾选协议
login_protocol_fail = By.XPATH,"/html/body/div/div/div[2]/div/div[1]/div[3]/div/div[4]/div/span"

# 用户名或者密码错误
login_account_or_pwd_error = By.XPATH,"//span[text()='用户名或密码错误']"

login_verify_code=By.XPATH,"/html/body/div/div/div[2]/div/div[1]/div[3]/div/div[5]/div/div/div[2]"
#################################################################################################################
# 点击购买火车票
